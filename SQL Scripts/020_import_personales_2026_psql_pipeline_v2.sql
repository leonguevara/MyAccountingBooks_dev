-- 020_import_personales_2026_psql_pipeline_v2.sql
...
--   \i /absolute/path/020_import_personales_2026_psql_pipeline_v2.sql
--
-- Requirements:
...
--       psql ... -v json_file='/abs/path/file.json' -f 020_import_personales_2026_psql_pipeline_v2.sql
...
VALUES (gen_random_uuid(), 'PERSONALES_2026', 'Personal Chart of Accounts 2026', 'Personal chart of accounts (Mexico-oriented) for 2026', 'MX', 'es-MX', NULL, 'v1', TRUE, now(), now())
...
\if :{?json_file}
\else
\set json_file 'Personales_2026_normalized_for_import_with_account_type_code.json'
\endif
