-- 021_import_sat_2025_psql_fixed_v4.sql
...
VALUES (
  gen_random_uuid(),
  'SAT_2025',
  'SAT 2025 Business Chart of Accounts (Agrupador-based)',
  'SAT (Mexico) agrupador-based business chart of accounts, 2025 edition',
  'MX',
  'es-MX',
  NULL,
  'v1',
...
-- >>> EDIT THIS LINE <<<
-- Example:
--   \set JSON_PATH /Users/l00792192/Documents/dev/tmp/SAT_2025_normalized_for_import.json
\set JSON_PATH /Users/l00792192/Documents/dev/tmp/SAT_2025_normalized_for_import.json
...
\copy _stg_raw(payload) FROM '/Users/l00792192/Documents/dev/tmp/SAT_2025.ndjson'
