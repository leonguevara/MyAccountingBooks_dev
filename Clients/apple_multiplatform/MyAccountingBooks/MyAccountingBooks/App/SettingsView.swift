...
///
/// Preferences are persisted via `@AppStorage` (UserDefaults) using the keys
/// defined in `AppStorageKeys`, and are read throughout the app via those same keys.
struct SettingsView: View {

    /// Controls whether account codes are shown alongside account names in the COA tree rows.
